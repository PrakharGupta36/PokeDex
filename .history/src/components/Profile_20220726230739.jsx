  ...
  return (
    <>
      {loading ? (
        ...
        <div style={{ background: moreData.color.name }}>
              ...
              <div
                ...
                <div className='skills'>
                  ...
                  <div className='overflow'>
                    <div className='stat'>
                      <p style={{background:""}}> HP </p> <p> {data.stats[0].base_stat} </p>
                    </div>
                    <div className='stat'>
                      <p> HP </p> <p> {data.stats[1].base_stat} </p>
                    </div>
                    <div className='stat'>
                      <p> HP </p> <p> {data.stats[2].base_stat} </p>
                    </div>
                    <div className='stat'>
                      <p> HP </p> <p> {data.stats[3].base_stat} </p>
                    </div>
                    <div className='stat'>
                      <p> HP </p> <p> {data.stats[4].base_stat} </p>
                    </div>
                    <div className='stat'>
                      <p> HP </p> <p> {data.stats[5].base_stat} </p>
                    </div>
                    <div className='stat'>
                      <p> Tot </p> <p> {total.reduce((a, b) => a + b, 0)} </p>
                    </div>
                  </div>
                </div>
              </div>
